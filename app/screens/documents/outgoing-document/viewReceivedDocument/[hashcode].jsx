...
const viewOutgoingDocument = () => {
  ...
  const { data, refetch } = axios.get({
    key: ["outgoing-documents", hashcode],
    url: "outgoing-documents/" + hashcode,
  });

  return (
    <View className={`flex flex-1`}>
      <StackHeader headerTitle={"Outgoing Document - Received"} />
          ...
          >
            <View>
              <DocumentReceiver
                ...
                receivedDate={data?.receiver[0]?.received_date}
              />
